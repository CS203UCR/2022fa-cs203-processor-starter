...
.PHONY: autograde
autograde: bcd.exe 
	./bcd.exe -M 3600 -o bench.csv -s 33554432 -f bcd_solution_c
	./bcd.exe -M 3600 -o correctness.csv -v -s 32768 262144 -f bcd_solution_c
...
$(BUILD)bcd.o : OPTIMIZE=$(MATEXP_OPTIMIZE)
$(BUILD)bcd.s : OPTIMIZE=$(MATEXP_OPTIMIZE)
$(BUILD)bcd_main.o : OPTIMIZE=$(MATEXP_OPTIMIZE)

bcd.exe:  $(BUILD)bcd_main.o  $(BUILD)bcd.o $(BUILD)perfstats.o
	$(COMPILER) $(MATEXP_OPTIMIZE) $(BUILD)bcd_main.o  $(BUILD)perfstats.o $(BUILD)bcd.o -o bcd.exe
